...
(function () {
  ...
  // Click on any video preview banner
  document.querySelectorAll('.case-video-preview').forEach(preview => {
    const trigger = (e) => {
      const src   = preview.dataset.video;
    ...
    // Keyboard accessibility on play button
